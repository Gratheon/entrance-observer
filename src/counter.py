...
def count_bees_from_frames_async(frames, total_interactions, output_video_path=None, on_complete=None, detection_line_coefficient=None, video_writer=None, writer_fps=None, frame_shape=None, entrance_position='bottom', counting_mode='line', detection_rectangle=None):
    print(f"🐝 Starting bee counting for a batch of {len(frames)} frames", flush=True)
    upload_thread = threading.Thread(
        target=countBeesAndReportTelemetry,
        args=(frames, total_interactions, output_video_path, on_complete, detection_line_coefficient, video_writer, writer_fps, frame_shape, entrance_position, counting_mode, detection_rectangle),
    )
    upload_thread.start()
...
def countBeesAndReportTelemetry(frames, total_interactions, output_video_path=None, on_complete=None, detection_line_coefficient=None, video_writer=None, writer_fps=None, frame_shape=None, entrance_position='bottom', counting_mode='line', detection_rectangle=None):
    start_time = time.time()

    try:
        beesIn, beesOut, detectedBees, final_track_history = countBees(
            frames,
            output_video_path,
            detection_line_coefficient,
            video_writer,
            writer_fps,
            frame_shape,
            entrance_position,
...
def countBees(frames, output_video_path=None, detection_line_coefficient=None, video_writer=None, writer_fps=None, frame_shape=None, entrance_position='bottom', counting_mode='line', detection_rectangle=None):
    track_history.clear()
